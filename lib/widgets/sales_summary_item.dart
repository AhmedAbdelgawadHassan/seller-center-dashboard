...
import 'package:seller_center_dashboard/widgets/sales_sammary_item_chart.dart';

class SalesSummaryItem extends StatelessWidget {
  const SalesSummaryItem({super.key});
        ...
        child: Column(
          children: [
            Row(
              ...
              children: [
                Text('Order Volume', style: AppStyles.style15Bold(context)),
                Spacer(),
            ...
            Row(
              children: [
                Text('5.51K', style: AppStyles.style20Bold(context)),
                Gap(10),
                Icon(Icons.arrow_upward,size: 15,color: Colors.green,),
                Text('2.1%',style: AppStyles.style12Regular(context).copyWith(color: Colors.green),),
                Gap(10),
                Text('vs Last Week',style: AppStyles.style12SemiBold(context),)
                ]),
                Gap(20),
                 Expanded(child: SalesSammaryItemChart()),   // line chart
                 Gap(10),
                 Row(
